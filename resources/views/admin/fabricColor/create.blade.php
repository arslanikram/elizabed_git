        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Fabrics Color</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create New Fabric Color</li>
                </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add New Fabric Color</h4>
                  @if (count($errors) > 0)
                  ...
                  <form class="forms-sample" action="{{route('fabric-color.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
