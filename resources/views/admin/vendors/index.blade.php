...
@section('content')
<div class="row">
    <div class="md-8">abc</div>
    <div class="md-4">efd</div>
</div>
                    ...
                    <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                      ...
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased On: activate to sort column ascending" style="width: 97px;">Vendor Name</th>
                      ...
                      <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                              <a href="{{route('vendor.edit',$vendor->id)}}" class="btn btn-outline-primary">Edit</a>
                              @if($vendor->status == 'Active')
                              <a onclick="return confirm('Are you sure to make this Inactive ?')" href="{{url('admin/product/status-inactive/'.$vendor->id)}}" class="btn btn-outline-danger">Inactive</a>
                              @else
                              <a onclick="return confirm('Are you sure to make this Aactive ?')" href="{{url('admin/product/status-active/'.$vendor->id)}}" class="btn btn-outline-success">Active</a>
                              @endif
                            </td>
                        </tr>
                        <?php $counter++; ?>
