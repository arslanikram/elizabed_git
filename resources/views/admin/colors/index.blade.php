        ...
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <a href="{{route('colors.create')}}" class="btn btn-primary btn-sm">Create New</a>
                    </ol>
                </nav>
            </div>
            <div class="card">
